...
if (window.location.pathname.includes("content.html")) {
    const messages = {
        ...
        3: "Något jag alltid har admireat med dig är din självdisciplin med att plugga påp egen hand! Väldigt få skulle kunna sätta sig ner och plugga i flera timmar i streck och verkligen fokusera på det dom gör. Jag minns att jag tänkt back in the day att inte skulle jag själv heller klara av det... Ditt självdisciplin kommer säkert från en kombination av flera saker och experiences du har som tex med att putta effort consistently när du har tränat eller din eager to learn new things. I love and admire att this about you <3",
